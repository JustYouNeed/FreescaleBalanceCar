...
//		oled_showNum(95, 33, Car.Sensor[SENSOR_V_R].Average, 3, 6, 12);
	...
	else if(showPage == 2)
	{
		...
		oled_showNum(27, 15, Car.PID.Velocity_Kp*10, 4, 6, 12);
		
		oled_showString(55, 15, "SKI:", 6, 12);
		oled_showNum(85, 15, Car.PID.Velocity_Ki*10, 4, 6, 12);
		
		oled_showString(3, 33, "DKP:", 6, 12);
		oled_showNum(27, 33, Car.PID.Turn_Kp, 4, 6, 12);
		
		oled_showString(55, 33, "DKD:", 6, 12);
		oled_showNum(85, 33, Car.PID.Turn_Kd, 4, 6, 12);
